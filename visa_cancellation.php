            ...
            <form method="POST">
                ...
                <fieldset><legend>Cancellation Details</legend>
                    <div class="grid">
                        ...
                        <div class="fgroup"><label>Cancellation Status</label><select name="cancellation_status"><option value="" <?php echo rv($rec,'cancellation_status')===''?'selected':''; ?>></option><?php foreach (vc_cancellation_statuses() as $s): ?><option value="<?php echo $s; ?>" <?php echo rv($rec,'cancellation_status')===$s?'selected':''; ?>><?php echo $s; ?></option><?php endforeach; ?></select></div>
