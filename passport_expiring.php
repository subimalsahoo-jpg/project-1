...
$today = date('Y-m-d');
$exp_col = passport_expiry_column($conn);

$result = passport_alert_query($conn);
...
<title>Expired &amp; Expiring Passports</title>
<style>
...
/* ── Urgency colouring ── */
/* already expired: still employed, working on an expired passport */
...
<div class="topbar">
    ...
    <div class="topbar-right">
        ...
        <span class="count-pill">&#9888; <?php echo $total_count; ?> Passport<?php echo $total_count > 1 ? 's' : ''; ?> to Action</span>
        <?php endif; ?>
...
<div class="page-body">
    ...
    <div class="page-heading">
        <div class="icon">&#128217;</div>
        <div>
            <h1>Expired &amp; Expiring Passports</h1>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="empty-state">
            <div class="icon">&#9888;</div>
            <h3 style="color:var(--red-dark);">Passport expiry column not found</h3>
            <p>No passport-expiry date field exists in the employees table yet.</p>
        </div>
    </div>
    <?php else: ?>
    ...
    <tr class="<?php echo $urg; ?>">
        ...
        <td><?php echo h($row['passport'] ?? ''); ?></td>
        <td class="date-cell"><?php echo h(display_date_dmy($exp_value)); ?></td>
        <td>
            <?php if ($remaining < 0): ?>
    ...
    <tr>
        <td colspan="8">
            <div class="empty-state">
                <div class="icon">&#9989;</div>
                <h3>All Clear!</h3>
                <p>No employee passports expiring within the next month.</p>
            </div>
        </td>
    </tr>
    <?php } ?>
