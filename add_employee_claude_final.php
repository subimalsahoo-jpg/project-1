...
function salary_numbers_from_post() {
    ...
    $advance       = num_val('advance_amount');
...
$advance_value           = (float)first_val($search_employee, ['advance_amount'], 0);
...
$total_deduction_value = $advance_value + $insurance_value + $other_deduction_value;
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            <label>Insurance Issuing Date</label>
            <input type="date" name="insurance_issuing_date" value="<?php echo htmlspecialchars(val($search_employee, 'insurance_issuing_date')); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" min="0" name="advance_amount" id="advance_amount"
                   value="<?php echo htmlspecialchars(number_format($advance_value, 2, '.', '')); ?>">
        </div>
...
<div class="detail-box">
    ...
    <div class="detail-row"><b>Advance:</b>           <?php echo money($advance_value); ?> AED</div>
...
function calculateNetSalary() {
    ...
    var deductions = numberValue('advance_amount')
                   + numberValue('insurance_amount')
...
[
    ...
    'advance_amount', 'insurance_amount', 'other_deduction'
].forEach(function(id) {
    var el = document.getElementById(id);
